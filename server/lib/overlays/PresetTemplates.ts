...
export const PRESET_TEMPLATES: {
  ...
  {
    name: 'AniList Score',
    description: 'Shows AniList community score (/10) in top-left corner',
    type: 'rating',
    tags: ['Ratings'],
    // No condition - will automatically skip if anilistScore is undefined
    templateData: {
      width: 1000,
      height: 1500,
      elements: [
        ...
        },
        {
          ...
          height: 108,
          properties: {
            segments: [{ type: 'variable', field: 'anilistScore' }],
            fontSize: 60,
            fontFamily: 'Inter',
            fontWeight: 'bold',
            fontStyle: 'normal',
        ...
        },
        {
          ...
          properties: {
            iconType: 'custom-icon',
            iconPath: '/api/v1/posters/icons/system/anilist.svg',
            opacity: 100,
            grayscale: false,
          },
        },
...

  {
    ...
    description: 'Shows MyAnimeList score (/10) in top-left corner',
    type: 'rating',
    tags: ['Ratings'],
    // No condition - will automatically skip if malScore is undefined
    templateData: {
      width: 1000,
      height: 1500,
      elements: [
        ...
        },
        {
          ...
          height: 108,
          properties: {
            segments: [{ type: 'variable', field: 'malScore' }],
            fontSize: 60,
            fontFamily: 'Inter',
            fontWeight: 'bold',
            fontStyle: 'normal',
        ...
        },
        {
          ...
          properties: {
            iconType: 'custom-icon',
            iconPath: '/api/v1/posters/icons/system/myanimelist.svg',
            opacity: 100,
            grayscale: false,
          },
        },
