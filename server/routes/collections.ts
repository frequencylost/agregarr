  ...
  try {
    ...
    switch (type) {
      ...
      case 'anilist': {
        ...
        // - staff pages: /staff/:id or /staff/:id/:name (creator/author/etc.)
        // - studio pages: /studio/:id or /studio/:id/:name
        const anilistPattern =
          /^(?:\/user\/[^/]+\/(?:animelist|list)\/[^/?]+|\/(?:animelist|list)\/[^/?]+|\/search\/anime(?:\/[^/?]+)?|\/anime\/\d+(?:\/[^/?]*)?|\/staff\/\d+(?:\/[^/?]*)?|\/studio\/\d+(?:\/[^/?]*)?)\/?$/;
